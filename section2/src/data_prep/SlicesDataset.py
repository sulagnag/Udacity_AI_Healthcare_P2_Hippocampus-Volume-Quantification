...
class SlicesDataset(Dataset):
    ...
    def __init__(self, data):
        self.transform = transforms.Compose([
            ...
            #transforms.RandomAffine(degrees=15,translate=(0.1,0.1),scale=(0.1,0.2),shear=0.1),
            transforms.ToTensor()])
    ...
    def __getitem__(self, idx):
        ...
        i = self.data[imn]["image"][xv,:,:]
        m = self.data[imn]["seg"][xv,:,:]
        im =i.astype(dtype=np.float32)
